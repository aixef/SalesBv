	...
	Showhide : function(component, event, helper) {
         ...
         switch (vidcheck) {
             ...
             case "18":
                 ...
                 break;
             case "19":
                           component.find("Minimo19").set("v.disabled", !checkBoxState);
                           component.find("Maximo19").set("v.disabled", !checkBoxState);
                           component.set("v.mes19",checkBoxState);
                 break;
             case "20":
                           component.find("Minimo20").set("v.disabled", !checkBoxState);
                           component.find("Maximo20").set("v.disabled", !checkBoxState);
                           component.set("v.mes20",checkBoxState);
                 break;
             case "21":
                           component.find("Minimo21").set("v.disabled", !checkBoxState);
                           component.find("Maximo21").set("v.disabled", !checkBoxState);
                           component.set("v.mes21",checkBoxState);
                 break;
             case "22":
                           component.find("Minimo22").set("v.disabled", !checkBoxState);
                           component.find("Maximo22").set("v.disabled", !checkBoxState);
                           component.set("v.mes22",checkBoxState);
                 break;
             case "23":
                           component.find("Minimo23").set("v.disabled", !checkBoxState);
                           component.find("Maximo23").set("v.disabled", !checkBoxState);
                           component.set("v.mes23",checkBoxState);
                 break;
             case "24":
                           component.find("Minimo24").set("v.disabled", !checkBoxState);
                           component.find("Maximo24").set("v.disabled", !checkBoxState);
                           component.set("v.mes24",checkBoxState);
                 break;
             case "36":
                           component.find("Minimo36").set("v.disabled", !checkBoxState);
                           component.find("Maximo36").set("v.disabled", !checkBoxState);
                           component.set("v.mes36",checkBoxState);
                 break;
             case "48":
                           component.find("Minimo48").set("v.disabled", !checkBoxState);
                           component.find("Maximo48").set("v.disabled", !checkBoxState);
                           component.set("v.mes48",checkBoxState);
                 break;
         }
    }
})
